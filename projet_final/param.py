...
def obtenir_valeurs(entree_nb_joueurs, entree_mise):
    ...
    Arguments :  entree_nb_joueurs, le nombre de joueur qu'il y aura dans la partie, integer comprit entre 1 et 7 
                 entree_mise, la mise, fictive, qu'on mettre en jeu, integer 

    Return nb_joueurs, la donnée rentrée pour entree_nb_joueurs
           mise, la donnée rentrée pour entree_mise
...
def jouer(entree_nb_joueurs,entree_mise,root_param):
    '''
    Appelle la fonction précédente et la fonction BouclePrincipale du fichier fonction

    Arguments :  entree_nb_joueurs, le nombre de joueur qu'il y aura dans la partie, integer comprit entre 1 et 7 
                 entree_mise, la mise, fictive, qu'on mettre en jeu, integer 
                 root_param, une racine tkinter pour afficher une fentre
...
def paramètre(root_menu):
    '''
    Permet de créer la fenetre de séléction des paramètres, mise et nombre de joueur 

    Argument :  root_menu, une racine tkinter pour lancer la fenetre

    Return rien mais permet d'afficher la fenetre
    ...
    # Stylise les labels et le bouton
    style = ttk.Style()
